...
def run():
    ...
    numSteps1 = 256  # Note that numSteps * motorStepAngle must be in increments of 2 degrees
    numSteps2 = 256
    ...
    # sigmaFM_data_file = open(r"/Users/leahkiner/Desktop/sigma_FMDataM2M1.txt", "w+")
    ...
    gimbalTipAngles_data_file = open(r"/Users/leahkiner/Desktop/gimbal_tip_dataM2M1.txt", "w+")
    np.savetxt(gimbalTipAngles_data_file, gimbal1AngleData)
    gimbalTipAngles_data_file.close()

    gimbalTiltAngles_data_file = open(r"/Users/leahkiner/Desktop/gimbal_tilt_dataM2M1.txt", "w+")
