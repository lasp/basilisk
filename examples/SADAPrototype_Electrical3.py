...
def EOM(t, X, Ih, Ip, panelThetaRef, panelThetaDotRef, V_a, V_b, resistance, inductance, backEMFAmplitude, friction, numTeeth):
...
def run(show_plots):
    ...
    # Check to ensure the rotor and sator are properly configured
