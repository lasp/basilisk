...
def run():
    ...
    numSteps1 = 32  # Note that numSteps * motorStepAngle must be in increments of 2 degrees
    numSteps2 = 32
    ...
    # SEQUENCE 2
    motor1InitAngle = motor1Angle
    motor2InitAngle = motor2FinalAngle

    # MOVE MOTOR 1
    motor1 = True
    motor2 = False
    intermediateInitialAngle = motor1Angle
    motor1FinalAngle = motor1Angle
    for idx1 in range(numSteps1):
        motor1FinalAngle = motor1InitAngle + ((idx1 + 1) * motorStepAngle)
        tInit = t
    ...
    # sigmaFM_data_file = open(r"/Users/leahkiner/Desktop/sigma_FMDataM1M2_16.txt", "w+")
    ...
    gimbalTipAngles_data_file = open(r"/Users/leahkiner/Desktop/gimbal_tip_dataM1M2_16.txt", "w+")
    np.savetxt(gimbalTipAngles_data_file, gimbal1AngleData)
    gimbalTipAngles_data_file.close()

    gimbalTiltAngles_data_file = open(r"/Users/leahkiner/Desktop/gimbal_tilt_dataM1M2_16.txt", "w+")
