...
def run():
    ...
    numSteps1 = 128  # Note that numSteps * motorStepAngle must be in increments of 2 degrees
    numSteps2 = 128
    ...
    # sigmaFM_data_file = open(r"/Users/leahkiner/Desktop/sigma_FMDataM1M2_4.txt", "w+")
    ...
    gimbalTipAngles_data_file = open(r"/Users/leahkiner/Desktop/gimbal_tip_dataM1M2_4.txt", "w+")
    np.savetxt(gimbalTipAngles_data_file, gimbal1AngleData)
    gimbalTipAngles_data_file.close()

    gimbalTiltAngles_data_file = open(r"/Users/leahkiner/Desktop/gimbal_tilt_dataM1M2_4.txt", "w+")
