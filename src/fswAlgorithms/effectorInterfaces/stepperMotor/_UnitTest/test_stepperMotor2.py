...
from Basilisk.fswAlgorithms import sepGimbalLookUpTable # import the module that is to be tested
...
def test_stepperMotor1SepTestFunction(show_plots, motor2Angle, accuracy):
    r"""
    ...
    **Description of Variables Being Tested**
    ...
    """
    [testResults, testMessage] = stepperMotorTestFunction(show_plots, motor2Angle, accuracy)
...
def stepperMotorTestFunction(show_plots, motor2_Angle, accuracy):
