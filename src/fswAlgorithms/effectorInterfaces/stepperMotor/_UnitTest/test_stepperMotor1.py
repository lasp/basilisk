...
def test_stepperMotorTestFunction(show_plots, motor1Angle, accuracy):
    r"""
    ...
    **Description of Variables Being Tested**
    ...
    """
    [testResults, testMessage] = stepperMotorTestFunction(show_plots, motor1Angle, accuracy)
...
def stepperMotorTestFunction(show_plots, motor1_Angle, accuracy):
    ...
    HingedRigidBodyMessageData.theta = motor1_Angle
    HingedRigidBodyMessage = messaging.HingedRigidBodyMsg().write(HingedRigidBodyMessageData)
    StepperMotorConfig.motor1AngleOutMsg.subscribeTo(HingedRigidBodyMessage)
