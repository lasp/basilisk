...
/*! This method is the main carrier for the reference frame calculation routine.
 @param CurrentSimNanos The current simulation time for system
 */
void SunPoint::UpdateState(uint64_t CurrentSimNanos)
{
