...
void CelestialTwoBodyPoint::parseInputMessages()
{
    ...
    if(this->secCelBodyIsLinked)
    {
        ...
        v3Subtract(secPlanet.v_BdyZero_N, navData.v_BN_N, this->v_P2B_N);
...
void CelestialTwoBodyPoint::computeCelestialTwoBodyPoint(uint64_t callTime)
{
    ...
    v3Cross(this->v_P1B_N, this->R_P2B_N, temp3_1);
    v3Cross(this->R_P1B_N, this->v_P2B_N, temp3_2);
    v3Add(temp3_1, temp3_2, v_N); /*Eq 4 */
    v3Cross(this->a_P1B_N, this->R_P2B_N, temp3_1);
    v3Cross(this->R_P1B_N, this->a_P2B_N, temp3_2);
    ...
    m33MultV3(C1, this->v_P1B_N, temp3);
    v3Scale(1.0 / v3Norm(this->R_P1B_N), temp3, dr1_hat); /* Eq 11a*/
    ...
    m33MultV3(C1, this->a_P1B_N, temp3_1);
    ...
    m33MultV3(temp33, this->v_P1B_N, temp3_2);
    v3Subtract(temp3_1, temp3_2, temp3);
    v3Scale(1.0 / v3Norm(this->R_P1B_N), temp3, ddr1_hat); /* Eq 13a*/
    ...
    m33tMultV3(dcm_RN, domega_RN_R, this->attRefOut.domega_RN_N);
