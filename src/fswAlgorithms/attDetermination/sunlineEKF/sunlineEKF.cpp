...
void SunlineEKF::Reset(uint64_t callTime)
{
    ...
    if (cssConfigInBuffer.nCSS > MAX_N_CSS_MEAS) {
        this->bskLogger.bskLog(BSK_ERROR, "sunlineEKF.cssConfigInMsg.nCSS must not be greater than "
...
//    double Gamma[6][3]={{this->dt*this->dt/2,0,0},{0,this->dt*this->dt/2,0},{0,0,this->dt*this->dt/2},{this->dt,0,0},{0,this->dt,0},{0,0,this->dt}};
...
void SunlineEKF::sunlineMeasUpdate(double updateTime)
{
    ...
    sunlineEKFUpdate(this->kalmanGain,
                     this->covarBar,
                     this->qObsVal,
                     this->numObs,
                     this->yMeas,
