...
SpinningBodyTwoDOFStateEffector::SpinningBodyTwoDOFStateEffector()
{
    ...
    ReadFunctor<HingedRigidBodyMsgPayload> emptyReadFunctor1;
    this->spinningBodyRefInMsgs.push_back(emptyReadFunctor1);
    ReadFunctor<HingedRigidBodyMsgPayload> emptyReadFunctor2;
    this->spinningBodyRefInMsgs.push_back(emptyReadFunctor2);
}
