%module(package="Basilisk.architecture.messaging") StepperMotorMsgPayload
%{
...
%include "msgPayloadDef/StepperMotorMsgPayload.h"
%{
    #include "msgPayloadDef/StepperMotorMsgPayload.h"
%}

INSTANTIATE_TEMPLATES(StepperMotorMsg)
