%module(package="Basilisk.architecture.messaging") ReconfigBurnInfoMsgPayload
%{
...
%include "msgPayloadDef/ReconfigBurnInfoMsgPayload.h"
%{
    #include "msgPayloadDef/ReconfigBurnInfoMsgPayload.h"
%}

INSTANTIATE_TEMPLATES(ReconfigBurnInfoMsg)
