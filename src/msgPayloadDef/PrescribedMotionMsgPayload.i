%module(package="Basilisk.architecture.messaging") PrescribedMotionMsgPayload
%{
...
%include "msgPayloadDef/PrescribedMotionMsgPayload.h"
%{
    #include "msgPayloadDef/PrescribedMotionMsgPayload.h"
%}

INSTANTIATE_TEMPLATES(PrescribedMotionMsg)
