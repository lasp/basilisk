%module(package="Basilisk.architecture.messaging") RealTimeFactorMsgPayload
%{
...
%include "msgPayloadDef/RealTimeFactorMsgPayload.h"
%{
    #include "msgPayloadDef/RealTimeFactorMsgPayload.h"
%}

INSTANTIATE_TEMPLATES(RealTimeFactorMsg)
