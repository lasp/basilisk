%module(package="Basilisk.architecture.messaging") SmallBodyNavMsgPayload
%{
...
%include "msgPayloadDef/SmallBodyNavMsgPayload.h"
%{
    #include "msgPayloadDef/SmallBodyNavMsgPayload.h"
%}

INSTANTIATE_TEMPLATES(SmallBodyNavMsg)
