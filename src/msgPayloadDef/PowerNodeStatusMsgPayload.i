%module(package="Basilisk.architecture.messaging") PowerNodeStatusMsgPayload
%{
...
%include "msgPayloadDef/PowerNodeStatusMsgPayload.h"
%{
    #include "msgPayloadDef/PowerNodeStatusMsgPayload.h"
%}

INSTANTIATE_TEMPLATES(PowerNodeStatusMsg)
