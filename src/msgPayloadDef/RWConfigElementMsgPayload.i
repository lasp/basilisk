%module(package="Basilisk.architecture.messaging") RWConfigElementMsgPayload
%{
...
%include "msgPayloadDef/RWConfigElementMsgPayload.h"
%{
    #include "msgPayloadDef/RWConfigElementMsgPayload.h"
%}

INSTANTIATE_TEMPLATES(RWConfigElementMsg)
